          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-white/90 rounded-full p-3">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 5v14l11-7L8 5z" fill="#111827"/></svg>
              </div>
            </div>
          </button>
        ) : (
          <iframe className="w-full h-full" src={`https://www.youtube.com/embed/${videoId}?autoplay=1`} title={title} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
        )}
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-20 md:pt-0 md:min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img src="/hero-farm.jpg" alt="Lush green farmland" className="w-full h-full object-cover" loading="lazy" decoding="async" />
        ...
        <div className="container relative z-10 py-12 md:py-32 mx-auto px-4 md:px-8">
          <div className="max-w-2xl space-y-6 md:space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-white drop-shadow-sm">
              {mounted ? t("Your land can earn money, even while you rest.") : ""}
            </h1>

            <p className="text-lg md:text-xl text-gray-200 max-w-lg">
              {mounted ? t("We find the farmers. We manage the work. You get paid every season. Simple.") : ""}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href={isLoggedIn ? "/dashboard/land" : "/login"} className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 text-base font-semibold rounded-xl bg-green-600 text-white hover:bg-green-700 transition-colors shadow-lg shadow-green-900/20">
                {mounted ? t("Register Your Land Free") : ""} <ArrowRight size={18} />
              </Link>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 p-4 lg:p-0">
            <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/5 to-green-light p-8 border border-border/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4 transition-colors">{mounted ? t("Easy to Get Started") : ""}</h3>
              <p className="text-muted-foreground leading-relaxed transition-colors">{mounted ? t("Share your land details and our team takes care of the rest.") : ""}</p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-accent/5 to-primary/5 p-8 border border-border/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-accent/10">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4 transition-colors">{mounted ? t("Complete Transparency") : ""}</h3>
              <p className="text-muted-foreground leading-relaxed transition-colors">{mounted ? t("Track farming activities through real-time updates, photos, and reports.") : ""}</p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-500/5 to-emerald-500/5 p-8 border border-border/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-green-500/10">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4 transition-colors">{mounted ? t("Professional Management") : ""}</h3>
              <p className="text-muted-foreground leading-relaxed transition-colors">{mounted ? t("Experienced teams handle all farming operations efficiently.") : ""}</p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-500/5 to-green-light p-8 border border-border/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/10">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4 transition-colors">{mounted ? t("Better Use of Your Land") : ""}</h3>
              <p className="text-muted-foreground leading-relaxed transition-colors">{mounted ? t("Convert unused land into productive farmland.") : ""}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-8 relative">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              {mounted ? t("No complicated process. No technical knowledge needed.") : ""}
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: mounted ? t("Just your name, land location, and a photo. Our team will call you within 24 hours to verify.") : "",
              },
              {
                num: "02",
                icon: Sprout,
                title: mounted ? t("We Manage Everything") : "",
                desc: mounted ? t("Our expert team takes full charge — from land prep and planting to monitoring and harvest. You get photo updates every week.") : "",
              },
              {
                num: "03",
                icon: Banknote,
                title: mounted ? t("Receive Your Returns") : "",
                desc: mounted ? t("After every harvest, money goes directly to your bank account. Track every rupee on your phone.") : "",
              },
            ].map((s, i) => (
              <div
                key={s.num}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-xl leading-relaxed">
                  {mounted ? t("If you own agricultural land but cannot actively manage it, Zenxity can help you generate income while ensuring modern, sustainable farming practices.") : ""}
                </p>
              </div>

              <ul className="space-y-6">
                {[
                  mounted ? t("Maximize your land's potential with professional management") : "",
                  mounted ? t("Receive regular updates directly on your device") : "",
                  mounted ? t("Completely hands-off experience for landowners") : "",
            ...
            <div className="relative lg:ml-auto w-full max-w-2xl">
              <div className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden aspect-video">
                <LazyYouTube videoId="6bC1KxqYACY" title="Your Farmland Is Sitting Idle? Let It Work For You 🌱" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="about" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-left max-w-3xl mb-16">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              {mounted ? t("We help landowners turn unused or underutilized agricultural land into productive farmland, managing the entire process with complete transparency.") : ""}
            </p>
          </div>

          <div className="mb-16">
            <div className="flex items-center gap-4 mb-4">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-foreground tracking-tight leading-tight">{mounted ? t("Our Mission") : ""}</h2>
            </div>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              {mounted ? t("We use tech and expert farm management to help landowners generate sustainable, transparent income.") : ""}
            </p>
          </div>
          ...
          <div className="space-y-8 max-w-4xl">
            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center gap-4 mb-6">
                <h3 className="text-2xl font-bold text-foreground">{mounted ? t("Our Services Include") : ""}</h3>
              </div>
      ...
      <section className="py-12 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl shadow-green-900/20">
            {/* Background Image */}
            <div className="absolute inset-0">
              <img src="/plowing.jpg" alt="Farming CTA Background" className="w-full h-full object-cover" loading="lazy" decoding="async" />
            ...
            <div className="relative z-10 px-8 py-16 md:py-20 md:px-16 text-center text-white">
              ...
              <p className="text-lg hidden md:block md:text-xl mb-10 max-w-2xl mx-auto text-green-50 drop-shadow">
                {mounted ? t("Submit your land details and let our farming experts handle the rest. Sit back, relax, and watch your unused land turn into a steady source of income.") : ""}
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Link href={isLoggedIn ? "/dashboard" : "/login"} className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto bg-white text-green-700 hover:bg-gray-50 px-6 py-5 sm:px-8 sm:py-6 text-base sm:text-lg font-semibold rounded-xl shadow-xl transition-transform hover:-translate-y-1">
                    {mounted ? t("Get Started Now") : ""} <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
                </Link>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground font-medium">{mounted ? t("Phone") : ""}</p>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground font-medium">{mounted ? t("Email") : ""}</p>
              ...
              >
                <MessageCircle size={20} /> {mounted ? t("Chat on WhatsApp") : ""}
              </a>
            </div>
            ...
            <div className="relative lg:ml-auto w-full max-w-lg">
              <div className="bg-white rounded-3xl p-8 shadow-xl shadow-gray-200/50 border border-gray-100">
                <form className="space-y-5" onSubmit={handleContactSubmit}>
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">{mounted ? t("Name") : ""}</label>
                    <input required type="text" placeholder={mounted ? (t("Your name") as string) : ""} value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-green-600/50 focus:border-green-600 text-base transition-colors" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">{mounted ? t("Phone Number") : ""}</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">{mounted ? t("Your District") : ""}</label>
                    <input required type="text" placeholder={mounted ? (t("e.g. Coimbatore") as string) : ""} value={formData.district} onChange={(e) => setFormData({ ...formData, district: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-green-600/50 focus:border-green-600 text-base transition-colors" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">{mounted ? t("Message") : ""}</label>
                    <textarea required rows={4} placeholder={mounted ? (t("Tell us about your land...") as string) : ""} value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-green-600/50 focus:border-green-600 text-base resize-none transition-colors" />
                  </div>
                  <button type="submit" disabled={isSubmitting} className="w-full py-3.5 rounded-xl bg-green-600 text-white font-semibold text-base hover:bg-green-700 transition-colors shadow-md shadow-green-600/20 disabled:opacity-70">
                    {mounted ? (isSubmitting ? t("Sending...") : t("Send Message")) : ""}
                  </button>
                </form>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-zinc-400 leading-relaxed pr-4">{mounted ? t("Let Your Land Work for You.") : ""}</p>
            </div>
            <div>
              <h4 className="font-semibold text-white text-lg mb-6">{mounted ? t("Services") : ""}</h4>
              <ul className="space-y-3 text-zinc-400">
                <li><a href="#" className="hover:text-green-400 transition-colors">{mounted ? t("Land Preparation") : ""}</a></li>
                <li><a href="#" className="hover:text-green-400 transition-colors">{mounted ? t("Seeding") : ""}</a></li>
                <li><a href="#" className="hover:text-green-400 transition-colors">{mounted ? t("Crop Management") : ""}</a></li>
                <li><a href="#" className="hover:text-green-400 transition-colors">{mounted ? t("Harvesting") : ""}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-white text-lg mb-6">{mounted ? t("Support") : ""}</h4>
              <ul className="space-y-3 text-zinc-400">
                <li><a href="#" className="hover:text-green-400 transition-colors">{mounted ? t("Help Center") : ""}</a></li>
                <li><a href="#contact" className="hover:text-green-400 transition-colors">{mounted ? t("Contact Us") : ""}</a></li>
                <li><Link href="/privacy" className="hover:text-green-400 transition-colors">{mounted ? t("Privacy Policy") : ""}</Link></li>
                <li><Link href="/terms" className="hover:text-green-400 transition-colors">{mounted ? t("Terms of Service") : ""}</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-white text-lg mb-6">{mounted ? t("Contact Us") : ""}</h4>
